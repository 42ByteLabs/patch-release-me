...
- name: "Patch Release Me"
  uses: 42ByteLabs/patch-release-me@0.6.0
  with:
    # Bump (patch)
    mode: bump
```
...
```bash
docker pull ghcr.io/42bytelabs/patch-release-me:0.6.0
```

**Run Image:***

```bash
docker run -it --rm -v $PWD:/app ghcr.io/42bytelabs/patch-release-me:0.6.0 patch-release-me --help
```
